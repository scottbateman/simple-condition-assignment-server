...
const DB_NAME = "default_condition.db";             //database name... this database file will be created unless already exists
const CONDITIONS = ['condition1','condition2'];     //provide the name of the conditions
